...
if ( ! class_exists( 'Touriztolite_Widget_Area' ) ) {

	class Touriztolite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'touriztolite-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'touriztolite-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'touriztolite-theme/widget_area/classes', $classes, $area_id );
	...
	function touriztolite_widget_area() {
		return Touriztolite_Widget_Area::get_instance();
	}

	touriztolite_widget_area();
}
