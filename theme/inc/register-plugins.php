 ...
 */
add_action( 'tgmpa_register', 'touriztolite_register_required_plugins' );
/**
 ...
 */
function touriztolite_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'   => esc_html__( 'Jet Plugins Wizard', 'touriztolite' ),
