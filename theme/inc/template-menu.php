 ...
 * @return void
 */
function touriztolite_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'touriztolite-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'touriztolite_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'touriztolite' ),
			) );
 ...
 * @return void
 */
function touriztolite_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'touriztolite-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'touriztolite' ),
		) );
 ...
 * @return string
 */
function touriztolite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'touriztolite-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'touriztolite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'touriztolite' ),
	), $context, $type );
 ...
 * @return void
 */
function touriztolite_set_nav_menu( $args ) {
